      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-20 md:px-6 md:py-28">
        ...
        <div className="mt-10 grid auto-rows-[minmax(0,1fr)] grid-cols-1 gap-3 sm:grid-cols-2 md:gap-4 lg:grid-cols-6">
          ...
          <Card className="group lg:col-span-2 lg:row-span-1 hover:border-foreground/30">
            <CommandBarTrigger
              prefill={`Submit a startup in ${CITIES.find((c) => c.key === city)?.label} — paste a link or describe the company:\n`}
              className="flex h-full flex-col justify-between gap-6 p-6 text-left"
            >
              <div>
                <div className="font-mono text-[11px] uppercase tracking-wider text-muted-foreground">
                  Contribute
